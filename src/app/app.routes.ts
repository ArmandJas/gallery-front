...
import {PHOTO_LIST_FULL_PATH, PHOTO_UPLOAD_PATH, PHOTO_VIEW_FULL_PATH} from 'src/app/core/util/routing-constants';
...
export const routes: Routes = [
  {path: PHOTO_LIST_FULL_PATH, component: PhotoListComponent},
